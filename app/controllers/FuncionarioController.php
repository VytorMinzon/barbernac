...
class FuncionarioController extends Controller
{
    ...
    public function adicionar()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $salario = filter_input(INPUT_POST, 'salario_funcionario', FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
            ...
            if ($nome && $telefone && $cargo && $email && $senha && $tipo_funcionario && $cpf_cnpj_funcionario && $id_uf && $status_funcionario) {
                $dadosFuncionario = [
