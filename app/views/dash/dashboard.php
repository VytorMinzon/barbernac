        ...
        <div class="sidebar" data-image="<?= BASE_URL ?>/assets/img/hero-bg2.jpg">
            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li>
                        <a class="nav-link" href="<?= BASE_URL ?>agendamento/listar">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navigation">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?= BASE_URL ?>auth/sair">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            if (isset($conteudo)) {
                                ...
                                echo '<h2 style="color: white;">Bem-vindo ao Dashboard!</h2>';
                            }
                ...
                <div class="container-fluid">
                    <nav>
                        ...
                        <p class="copyright text-center">
                            ...
                            <strong>Barbernac</strong> - Todos os direitos reservados
                        </p>
                    </nav>
                </div>
            </footer>
