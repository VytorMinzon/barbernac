<?php
$funcionario = $funcionario ?? $dados['funcionario'] ?? null;
...
<style>
    /* Estilo uniforme para todos inputs e selects */
    input.form-control,
    select.form-select {
        background-color: rgba(28, 30, 34, 0.8);
        color: #f0c674 !important;
        /* texto dourado uniforme */
...
<form method="POST" action="<?= BASE_URL ?>funcionario/editar/<?= $funcionario['id'] ?>" enctype="multipart/form-data">
    <div class="container my-5">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                ?>
                <img src="<?= $img ?>" alt="Foto do Funcionário" class="img-fluid" id="preview-img" style="width:100%; cursor:pointer;">
            ...
            <div class="col-md-8">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nome_funcionario" name="nome_funcionario" value="<?= htmlspecialchars($funcionario['nome_funcionario']) ?>" required>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="tipo_funcionario" name="tipo_funcionario" required>
                            <option value="Física" <?= ($funcionario['tipo_funcionario'] == 'Física') ? 'selected' : '' ?>>Pessoa Física</option>
                            <option value="Jurídica" <?= ($funcionario['tipo_funcionario'] == 'Jurídica') ? 'selected' : '' ?>>Pessoa Jurídica</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                        <label for="cpf_cnpj_funcionario" class="form-label">CPF/CNPJ:</label>
                        <input type="text" class="form-control" id="cpf_cnpj_funcionario" name="cpf_cnpj_funcionario" value="<?= htmlspecialchars($funcionario['cpf_cnpj_funcionario']) ?>" required>
                    </div>
                </div>
                ...
                <div class="row g-3 mt-2">
                    ...
                    <div class="col-md-6 position-relative">
                        ...
                        <input type="password" class="form-control" id="senha" name="senha" placeholder="••••••••" maxlength="8" style="padding-right: 70px;">
                ...
                <div class="row g-3 mt-2">
                    <div class="col-md-4">
                        ...
                        <input type="tel" class="form-control" id="telefone" name="telefone" value="<?= htmlspecialchars($funcionario['telefone']) ?>" required>
                    </div>
                    <div class="col-md-4">
                        <label for="cargo" class="form-label">Cargo:</label>
                        <input type="text" class="form-control" id="cargo" name="cargo" value="<?= htmlspecialchars($funcionario['cargo']) ?>" required>
                    </div>
                    <div class="col-md-4">
                        <label for="salario_funcionario" class="form-label">Salário:</label>
                        <input type="number" step="0.01" class="form-control" id="salario_funcionario" name="salario_funcionario" value="<?= htmlspecialchars($funcionario['salario_funcionario']) ?>">
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="id_uf" name="id_uf">
                            ...
                            <?php foreach ($estados as $estadoItem): ?>
                                <option value="<?= $estadoItem['id_uf'] ?>" <?= ($funcionario['id_uf'] == $estadoItem['id_uf']) ? 'selected' : '' ?>>
                                    <?= $estadoItem['nome_uf'] ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
