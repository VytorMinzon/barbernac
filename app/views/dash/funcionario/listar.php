        ...
        <tbody>
            <?php foreach ($listaFuncionario as $linha): ?>
                <tr>
                    ...
                    <td><?= htmlspecialchars($linha['salario_funcionario']) ?></td>
                    <td><?= htmlspecialchars($linha['email']) ?></td>
                    <td><?= htmlspecialchars($linha['telefone']) ?></td>
                    <td>
                        <a href="<?= BASE_URL ?>funcionario/editar/<?= $linha['id'] ?>" class="btn btn-glass" title="Editar">
...
<div class="d-flex justify-content-center align-items-center mb-4 flex-column gap-3">
    ...
    <a href="<?= BASE_URL ?>funcionario/adicionar" class="btn btn-add">
