...
<form method="POST" action="<?= BASE_URL ?>servico/adicionar" enctype="multipart/form-data">
    <div class="container my-5">
        <div class="row">
            <!-- Imagem de preview -->
            <div class="col-md-4">
                <img src="<?= htmlspecialchars($img) ?>" alt="Preview do Serviço" class="img-fluid" id="preview-img" title="Clique para escolher a foto">
                <input type="file" name="foto_servico" id="foto_servico" style="display: none;" accept="image/*">
                <small class="text-muted d-block mt-2">Clique na imagem para escolher uma foto</small>
            </div>
