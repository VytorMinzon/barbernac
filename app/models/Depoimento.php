...
{
    // Lista todos os depoimentos com informações do cliente
    ...
    public function addDepoimento($dados)
    {
        ...
        // Se você quiser usar o timestamp atual do banco, pode remover esse bind e usar NOW() no SQL
        $stmt->bindValue(':data_depoimento', $dados['data_depoimento']); // Formato: 'Y-m-d H:i:s'
